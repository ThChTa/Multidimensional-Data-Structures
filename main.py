...
if user_choice=='1':
    ...
    # Call the function with data and use word shingles (k=1 for individual words)
        ...
        if not query_results:
            ...
            lsh_for_multiple_strings(education_array_from_r_tree, info_from_r_tree, threshold, printer=1, k=1, nbits=20, bands=10)
    elif user_choice == '2':
        ...
        if not kd_tree_results:
            ...
            lsh_for_multiple_strings(education_array_from_kd_tree, info_from_kd_tree, threshold,printer=1, k=1, nbits=20, bands=10)
    elif user_choice == '3':
        ...
        if not quad_tree_results:
            ...
            lsh_for_multiple_strings(education_array_from_quad_tree, info_from_quad_tree, threshold,printer=1, k=1, nbits=20, bands=10)
    elif user_choice == '4':
        ...
        if not results:
            ...
            lsh_for_multiple_strings(education_array_from_range_tree, info_from_range_tree,threshold,printer=1, k=1, nbits=20, bands=10)
